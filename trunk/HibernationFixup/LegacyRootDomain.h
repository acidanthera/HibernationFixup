...
public:
    ...
    virtual IOReturn    getAggressiveness( unsigned long, unsigned long * ) override;
...
/*! @function registerPMSettingController
    ...
    virtual IONotifier * registerInterest(
                                ...
                                IOServiceInterestHandler handler,
                                void * target, void * ref = 0 ) override;
...
private:
    ...
    virtual IOReturn    requestPowerDomainState( IOPMPowerFlags, IOPowerConnection *, unsigned long ) override;
    virtual void        powerChangeDone( unsigned long ) override;
    virtual bool        tellChangeDown( unsigned long ) override;
    virtual bool        askChangeDown( unsigned long ) override;
    virtual void        tellChangeUp( unsigned long ) override;
    virtual void        tellNoChangeDown( unsigned long ) override;
};
